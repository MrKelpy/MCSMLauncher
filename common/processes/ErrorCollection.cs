...
namespace MCSMLauncher.common.processes
{
    ...
    public class ErrorCollection : ICollection<string>
    {
        ...
        /// </summary>
        private List<string> InternalErrorCollection { get; set; } = new List<string>();
        ...
        /// purposes.
        /// </summary>
        public IEnumerator<string> GetEnumerator() => InternalErrorCollection.GetEnumerator();
        ...
        public void Add(string item) => InternalErrorCollection.Add(item);
        ...
        /// <returns></returns>
        public bool Remove(string item) => InternalErrorCollection.Remove(item);

        /// <summary>
        /// Clears the ErrorCollection
        /// </summary>
        public void Clear() => InternalErrorCollection.Clear();
        ...
        public bool Contains(string item) => InternalErrorCollection.Contains(item);
        ...
        public bool StringMatches(string match) => InternalErrorCollection.Any(match.Contains);
        ...
        public void CopyTo(string[] array, int arrayIndex) { InternalErrorCollection.ToArray().CopyTo(array, arrayIndex);}
    }
}